				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="cuenta.php"> Crea tu cuenta</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="col-lg-4 d-flex flex-column address-wrap">
							<div class="single-contact-address d-flex flex-row">
								...
								<div class="contact-details">
									...
									<p>Con la creación de esta cuenta, <br>podrás acceder al catálogo de productos, en el cual ahora, <br>podras hacer pedidos!</p>
									<?php 
                                   ...
                                   'usuario','activo');";
                                        ...
                                        $mensaje = 'Registro completado. Inicia sesión haciendo click <a href="login.php">aquí</a>';
                                         $datos['nombre'] = "";							        	
							        	$datos['apellido'] = "";
							        	$datos['pass'] = "";
							        	$datos['email'] = "";
							...
							<form class="form-area"  method="POST" class="contact-form text-right">
								<div class="row">	
									<div class="col-lg-6 form-group">
										<input value='<?php if (isset($datos["nombre"])){ echo $datos["nombre"]; }?>' name="name" placeholder="Introduce tu nombre" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce tu nombre'" class="common-input mb-20 form-control" required="" type="text">

										<input value='<?php if (isset($datos['apellido'])){ echo $datos['apellido']; }?>' name="lastname" placeholder="Introduce tu apellido" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce tu apellido'" class="common-input mb-20 form-control" required="" type="text">
										...
										<input value='<?php if (isset($datos['tel'])){ echo $datos['tel']; }?>' name="telefono" placeholder="Introduce tu numero de teléfono" pattern="[0-9]{8}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduce tu numero de teléfono'" class="common-input mb-20 form-control" required="" type="text">
									</div>
							        <div class="col-lg-6 form-group">

							        	<input value='<?php if (isset($datos['direc'])){ echo $datos['direc']; }?>' name="direccion" placeholder="Introduzca su dirección" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Introduzca su dirección'" class="common-input mb-20 form-control" required="" type="text">

							        </div>
									<div class="col-lg-12 d-flex justify-content-between">
										<div class="alert-msg" style="text-align: left;"></div>
										<input type="submit" name="crear" class="genric-btn primary circle" name="crear" value = "Registrarse" style="float:left;">	</input>
